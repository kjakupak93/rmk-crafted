...
|---|---|---|---|
| Smoke | `npx playwright test --project=smoke` | 27 | UI presence, navigation, no data writes |
| E2E | `npx playwright test --project=e2e` | 64 | Full workflows with real Supabase reads/writes |
