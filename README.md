...
|---|---|---|---|
| Smoke | `npx playwright test --project=smoke` | 26 | UI presence, navigation, no data writes |
| E2E | `npx playwright test --project=e2e` | 66 | Full workflows with real Supabase reads/writes |
